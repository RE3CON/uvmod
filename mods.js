   ...
   /*  class Mod_ABR extends FirmwareMod {//just testing...
    ...
    , 
     class Mod_RSSI extends FirmwareMod {
        constructor() {
            super("RSSI (S-Meter/VU-Meter w. Batt-Voltage Mod)", "Adds a battery voltage readout in the status bar. Replaces the signal strength meter with a numerical RSSI readout and adds another optional element (signal strength in 6dB increments) Modulation/FM hub VU meter.", "2250");
