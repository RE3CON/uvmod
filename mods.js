...
/* DO PAY PROPPER CREDITS! CODE TX RX on all Bands 18-1300 diffs by RE3CON, CODE Disable TX Lock by RE3CON */      
  ...
  class Mod_CustomTXRange extends FirmwareMod {
    ...
    class Mod_DisableTXlock extends FirmwareMod {
        constructor() {
            super("Disable TX Lock from 50-600 and 18-1300 MHz with Mod Freq Band Ranges", "Enables transmitting on frequencies from 50 MHz to 600 MHz / 18-1300 MHz. The harmonic wave radiation can be stronger than on the input frequency and cause severe interference!", 0);
        }
   ...
   class Mod_DisableTX extends FirmwareMod {
    ...
    class Mod_FrequencyRangeAdvanced extends FirmwareMod {
        constructor() {
            super("Custom Frequency Band Ranges", "Changes the frequency range limits. Required for disable TX Lock Mod 18-1300MHz", 0);
   ...
   class Mod_FrequencySteps extends FirmwareMod {
        ...
        apply(firmwareData) {
            ...
            for (let i = 0; i < steps.length; i++) {
                dataView.setUint16(i * 2, steps[i], true);
            }
    ...
    ,
     class Mod_AirCopy extends FirmwareMod {
        constructor() {
            super("AIR COPY Freq", "Change the AIR COPY Freq to transfer/receive wireless the radio settings with stored memory channels from one radio to another over the air. The default is 410,025 MHz. Enter this feature by press F2 [Flashlight] + PTT together while switching power on.", 0);
...
// Mod_Tone_ToneBurst by RE3CON converted/rewritten to java from python mod by IK8JHL mod_change_Tone_1750Hz.py !!! DO Pay propper credits !!!
    class Mod_5tonetest extends FirmwareMod {
        constructor() {
            super("5-tone ZVEI2 (Experimental)", "To send a selective 5-tone ZVEI2 (Tones: 1270, 1060, 2200, 1160 Hz) instead of DTMF 123A1", 0);
    ...
    class Mod_EnableSWDPort extends FirmwareMod {
        constructor() {
            super("Enable SWD Port", "Allows via SWD (Serial Wire Debug). Requires to solder 2-pin wire on the radios mainboard. Alternative to JTAG using the same protocol. This is to gain full control over the HW. ", 0);
        }
        apply(firmwareData) {
  ...
  class Mod_BatteryIcon extends FirmwareMod {
    ...
    class Mod_FontBigDigits extends FirmwareMod {
        constructor() {
            super("Modified LCD Font (large numbers)", "Changes the font to one of the selected ones: ", 0);
...
//                const bigDigits = hexString("");
    ...
    class Mod_FontSmallDigits extends FirmwareMod {
        constructor() {
            super("Modified LCD Font (small numbers)", "Changes the font to one of the selected ones: ", 0);
...
class Mod_FontLetters extends FirmwareMod {
        constructor() {
            super("Modified LCD Font (letters)", "Changes the font to one of the selected ones: ", 0);
    ...
    class Mod_BacklightDuration extends FirmwareMod {
        constructor() {
            super("Backlight Duration", "Sets a multiplier for the backlight time out duration.", 0);
