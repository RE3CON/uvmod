...
Not only Air Band but also Millitary, emergency services and so forth could be affected when you use it wrong. TX below 136 MHz produce a lot Harmonics on other frequencies with more transmitting power than the on the wanted transmit frequency shown on LCD.
